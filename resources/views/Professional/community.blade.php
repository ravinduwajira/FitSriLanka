    ...
    <div class="card shadow-sm mb-5 border-0">
        <div class="card-body">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <form action="{{ route('Professional.community.posts.destroy', $post->id) }}" method="POST" class="ms-3" onsubmit="return confirm('Are you sure you want to delete this post?')">
                    @csrf
                    @method('DELETE')
