          ...
          <li class="nav-item"><h4>{{ $profileData->name }}</h4></li>
                ...
                <ul class="list-unstyled p-1">
                  <li class="dropdown-item py-2">
                    <a href="{{ route('Professional.profile') }}" class="text-body ms-0">
                      <i class="me-2 icon-md" data-feather="user"></i>
                      <span>Profile</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
                    <a href="{{ route('Professional.logout') }}" class="text-body ms-0">
