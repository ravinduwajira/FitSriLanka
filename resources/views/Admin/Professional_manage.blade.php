...
<div><br>
    <div class="container py-5">
        <h1 class="text-center mb-4">Manage Professionals 🧑‍💼</h1>
            ...
            <table class="table table-hover align-middle" style="background-color: #d6d8db; color: #343a40;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #b1b3b5; font-weight: bold;">
                        ...
                        <td>{{ $user->address }}</td>
                        <td>
                            <form action="{{ route('Professional.delete', $user->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                @csrf
                                @method('DELETE')
