      ...
      <div class="card">
              <div class="card-body">
                                ...
                                <div class="mb-3">
										...
										<input type="text" name="name" class="form-control" id="Inputname" autocomplete="off" value="{{ $profileData->name }}">
									</div>
									<div class="mb-3">
										<label for="InputUsername" class="form-label">Username</label>
										<input type="text" name="username"  class="form-control" id="InputUsername" autocomplete="off" value="{{ $profileData->username }}">
									</div>
									<div class="mb-3">
                                    ...
                                    <div class="mb-3">
										...
										<input type="text" name="phone"  class="form-control" id="InputPhone" value="{{ $profileData->phone }}">
									</div>
									<div class="mb-3">
										<label for="InputAddress" class="form-label">Address</label>
										<input type="text" name="address"  class="form-control" id="InputAddress" value="{{ $profileData->address }}">
									</div>
									<div class="mb-3">
										<label class="form-label" for="Photo">Photo</label>
										<input class="form-control" name="photo"  type="file" id="photo" name="photo">
									</div>
                                    <div class="mb-3">
